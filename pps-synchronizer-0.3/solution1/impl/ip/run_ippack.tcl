...
## IP Info
set Vendor      "MazinLab"
set Library     "mkidgen3"
set IPName      "pps_synchronizer_control"
set Version     "0.3"
set DisplayName "PPS Synchronizer"
set Revision    "2113174436"
set Description "Create a counter synchronized to a 1PPS signal"
...
set xo_kernel_name "pps_synchronizer_control"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/cudaa/Workspace/hls/pps-synchronizer/pps-synchronizer/solution1"
set debug_dir "/home/cudaa/Workspace/hls/pps-synchronizer/pps-synchronizer/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {pps_synchronizer_control_control_s_axi
pps_synchronizer_control
}
set kernel_xo ""

## Variables
set Top "pps_synchronizer_control"
set TopNoPrefix "pps_synchronizer_control"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 mode_reg W 0x0 "Data signal of mode_reg" {{0 32 mode_reg W 0 "Bit 31 to 0 of mode_reg"}}} {0x18 counter_config_reg W 0x0 "Data signal of counter_config_reg" {{0 16 counter_config_reg W 0 "Bit 15 to 0 of counter_config_reg"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 counter_status_reg R 0x0 "Data signal of counter_status_reg" {{0 16 counter_status_reg R 0 "Bit 15 to 0 of counter_status_reg"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 counter_status_reg_ctrl R 0x0 "Control signal of counter_status_reg" {{0 1 counter_status_reg_ap_vld R 0 "Control signal counter_status_reg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 delay_ns_reg W 0x0 "Data signal of delay_ns_reg" {{0 32 delay_ns_reg W 0 "Bit 31 to 0 of delay_ns_reg"}}} {0x30 load_secs_reg W 0x0 "Data signal of load_secs_reg" {{0 32 load_secs_reg W 0 "Bit 31 to 0 of load_secs_reg"}}} {0x38 load_ns_reg W 0x0 "Data signal of load_ns_reg" {{0 32 load_ns_reg W 0 "Bit 31 to 0 of load_ns_reg"}}} {0x40 load_subns_reg W 0x0 "Data signal of load_subns_reg" {{0 8 load_subns_reg W 0 "Bit 7 to 0 of load_subns_reg"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 capture_secs_reg R 0x0 "Data signal of capture_secs_reg" {{0 32 capture_secs_reg R 0 "Bit 31 to 0 of capture_secs_reg"}}} {0x4c capture_secs_reg_ctrl R 0x0 "Control signal of capture_secs_reg" {{0 1 capture_secs_reg_ap_vld R 0 "Control signal capture_secs_reg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 capture_ns_reg R 0x0 "Data signal of capture_ns_reg" {{0 32 capture_ns_reg R 0 "Bit 31 to 0 of capture_ns_reg"}}} {0x5c capture_ns_reg_ctrl R 0x0 "Control signal of capture_ns_reg" {{0 1 capture_ns_reg_ap_vld R 0 "Control signal capture_ns_reg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 capture_subns_reg R 0x0 "Data signal of capture_subns_reg" {{0 8 capture_subns_reg R 0 "Bit 7 to 0 of capture_subns_reg"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x6c capture_subns_reg_ctrl R 0x0 "Control signal of capture_subns_reg" {{0 1 capture_subns_reg_ap_vld R 0 "Control signal capture_subns_reg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 current_secs_reg R 0x0 "Data signal of current_secs_reg" {{0 32 current_secs_reg R 0 "Bit 31 to 0 of current_secs_reg"}}} {0x7c current_secs_reg_ctrl R 0x0 "Control signal of current_secs_reg" {{0 1 current_secs_reg_ap_vld R 0 "Control signal current_secs_reg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 current_ns_reg R 0x0 "Data signal of current_ns_reg" {{0 32 current_ns_reg R 0 "Bit 31 to 0 of current_ns_reg"}}} {0x8c current_ns_reg_ctrl R 0x0 "Control signal of current_ns_reg" {{0 1 current_ns_reg_ap_vld R 0 "Control signal current_ns_reg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 current_subns_reg R 0x0 "Data signal of current_subns_reg" {{0 8 current_subns_reg R 0 "Bit 7 to 0 of current_subns_reg"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x9c current_subns_reg_ctrl R 0x0 "Control signal of current_subns_reg" {{0 1 current_subns_reg_ap_vld R 0 "Control signal current_subns_reg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 lockout_reg W 0x0 "Data signal of lockout_reg" {{0 16 lockout_reg W 0 "Bit 15 to 0 of lockout_reg"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 rollover_thresh_reg W 0x0 "Data signal of rollover_thresh_reg" {{0 32 rollover_thresh_reg W 0 "Bit 31 to 0 of rollover_thresh_reg"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3.906 machine 64 combinational 1 latency 0 II x}
...
source -notrace "/localdata/xilinx/Vitis_HLS/2022.1/common/scripts/ipxhls.tcl"
